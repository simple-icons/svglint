 ...
 */
async function execCliWith(arguments_, cwd = process.cwd(), input = null) {
    try {
...
describe('Configuration files', function () {
    ...
    it('should succeed in a project without a config file', async function () {
        const {stdout} = await execCliWith(
            [VALID_SVG],
