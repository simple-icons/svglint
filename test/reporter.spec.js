/**
 * @fileoverview Tests for lints reporter.
 */
...
describe('Reporter', () => {
	it('should report result without node', async () => {
		const results = await lint('<svg><title></title></svg>', {
			elm: {'svg > foobar': true},
		});
	...
	it('should report results with node', async () => {
	...
	it('should report result from exception', async () => {
